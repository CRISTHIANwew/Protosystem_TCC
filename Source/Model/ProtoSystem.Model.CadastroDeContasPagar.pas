...
begin
var
    frmPesquisaFornecedor: TfrmPesquisaFornecedor; // Declare uma variável para o formulário
  ...
  try
    ...
    frmPesquisaFornecedor.ShowModal; // Exiba o formulário de maneira modal
  finally
    frmPesquisaFornecedor.Free; // Libere a memória após fechar o formulário
  end;
...
procedure TfrmCadastroContasPagar.edtValorKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TfrmCadastroContasPagar.gridDocumentosDblClick(Sender: TObject);
begin
