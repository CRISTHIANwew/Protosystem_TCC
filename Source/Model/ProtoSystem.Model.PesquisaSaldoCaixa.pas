...
type
  TfrmPesquisaSaldoCaixa = class(TForm)
    Panel1: TPanel;
    Panel2: TPanel;
...
var
  frmPesquisaSaldoCaixa: TfrmPesquisaSaldoCaixa;
...
procedure TfrmPesquisaSaldoCaixa.btnCadastrarClick(Sender: TObject);
begin
  SQL_PesquisaSaldo.Refresh;
end;

procedure TfrmPesquisaSaldoCaixa.btn_saircadprodClick(Sender: TObject);
begin
  close;
end;
