O Sistema ProtoSystem tem como finalidade ser um Sistema de gestão desenvolvido para posterior avaliação de TCC na Faculdade Unicesumar Graduação em Engenharia de Software.
